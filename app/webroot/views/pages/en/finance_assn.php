		...
		<div class="limit--m fin-detail__aktiva">
			...
			<div class="ft-wrapper">
				<table class="ft">
					...
					<tr class="ft__row-line">
						<td class="ft__col-key">Advance payments</td>
		...
		<div class="limit--m fin-detail__passiva">
			...
			<div class="ft-wrapper">
				<table class="ft">
					...
					<tr class="ft__row-line">
						<td class="ft__col-key">Of these free reserves</td>
					...
					<tr class="ft__row-line">
						<td class="ft__col-key">Earmarked payables</td>
		...
		<div class="limit--m fin-detail__rechnung">
			...
			<div class="ft-wrapper">
				<table class="ft">
					...
					<tr class="ft__row-line">
						<td class="ft__col-key">Income from other investments</td>
					...
					<tr class="ft__row-foot ft__row-line">
						<td class="ft__col-key">Total income</td>
					...
					<tr class="ft__row-line">
						<td class="ft__col-key">Extraordinary expenditures</td>
						<td class="ft__col-val ft__green-border">0 €</td>
						<td class="ft__col-void"></td>
						<td class="ft__col-val">0 €</td>
						<td class="ft__col-void"></td>
					...
					<tfoot>
						<td class="ft__col-key">Retained profits</td>
	...
	<section class="section cp">
		<div class="limit--m fin-detail__mittel">
				...
				<div class="bagel__text">
					...
					<div class="bagel__info">
						<div class="bagel__line-1">
							<span class="t--delta bagel__label">Indirect project expenditures</span>
							<span class="t--delta bagel__amount">1.116.153 €</span>
						</div>
						<div class="bagel__line-2">
							<span class="t--delta bagel__label">Direct project expenditures</span>
			...
			<table class="ft ft--alloc">
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Attract and retain new volunteers for Wikimedia projects</td>
					<td class="ft__col-val ft__green-border">439.667 €</td>
				</tr>
				<tr class="ft__row-line">
					<td class="ft__col-key">Software development: extend Wikidata, implement the community’s needs, and further develop MediaWiki</td>
					<td class="ft__col-val ft__green-border">1.469.247 €</td>
				</tr>
				<tr class="ft__row-line">
					<td class="ft__col-key">Strengthen political and legal work efforts aimed at promoting free knowledge</td>
					<td class="ft__col-val ft__green-border">227.907 €</td>
				</tr>
				<tr class="ft__row-line">
					<td class="ft__col-key">Improve the relationship between the association and the communities</td>
					<td class="ft__col-val ft__green-border">735.158 €</td>
				</tr>
				<tr class="ft__row-line">
					<td class="ft__col-key">Attract educational, scientific, and cultural institutions for flagship projects</td>
					<td class="ft__col-val ft__green-border">189.853 €</td>
				</tr>
				<tr class="ft__row-line">
					<td class="ft__col-key">Promote framework for free knowledge through Open Educational Resources</td>
					<td class="ft__col-val ft__green-border">355.272 €</td>
				</tr>
				<tr class="ft__row-line">
					<td class="ft__col-key">Define and consolidate WMDE’s position within the international movement</td>
					<td class="ft__col-val ft__green-border">308.350 €</td>
				</tr>
				<tr class="ft__row-line">
					<td class="ft__col-key">Regionalization: continue and analyze</td>
					<td class="ft__col-val ft__green-border">91.535 €</td>
				</tr>
				<tr class="ft__row-line">
					<td class="ft__col-key">Involve volunteers</td>
					<td class="ft__col-val ft__green-border">612 €</td>
				</tr>
				<tr class="ft__row-line">
					<td class="ft__col-key">Achieve clarity on the association’s identity and strategy</td>
					<td class="ft__col-val ft__green-border">54.392 €</td>
				</tr>
				<tr class="ft__row-line">
					<td class="ft__col-key">Program support functions (e.g. communication, event management, etc.)</td>
