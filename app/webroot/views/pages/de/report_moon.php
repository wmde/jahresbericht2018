			...
			<div class="section__body t--gamma-serif">
				...
				<blockquote class="quote">
					<div class="quote__body">
						<p class="t--beta">
							„Was besonders toll an dem Projekt ist, ist, dass die Arbeit von vielen vielen tausend Leuten, die Wikipedia erst zu dem gemacht haben, was sie ist, tatsächlich auf dem Mond landet.“
						</p>
					</div>
					<footer class="quote__author t--gamma">
						Michael Jahn, Ansprechpartner Wikipedia to the Moon bei Wikimedia Deutschland
					</footer>
				</blockquote>
				<p>
					...
					<div class="swiper-slide">
						<div class="video">
							<div class="video__embed-container">
								<iframe src="https://player.vimeo.com/video/196444225?byline=0&title=0&portrait=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
							</div>
							<div class="video__caption limit--s">
								Wikipedia to the Moon Projektrückblick
					...
					<div class="swiper-slide">
						<figure class="fig">
							...
							<figcaption class="fig__caption limit--s">
								Jan Apel (WMDE) <a href="https://commons.wikimedia.org/wiki/File:Die_Part-Time_Scientists_mit_der_Wikipedia-Datendisc.jpg" target="new">(Wikimedia Commons)</a>, <a href="https://creativecommons.org/licenses/by-sa/4.0/legalcode" target="new">CC BY 4.0</a>
							</figcaption>
						</figure>
					</div>
					<div class="swiper-slide">
						<figure class="fig">
							<img class="fig__image" src="/assets/img/11_moon_lander.jpg" alt="Landemodul ALINA mit Wikipedia-Datendisc">
							<figcaption class="fig__caption limit--s">
