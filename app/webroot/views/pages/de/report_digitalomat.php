<main class="report-detail">
	<section
		...
		style="background-image: url(/assets/img/05_digitalomat_hero.jpg)"
	>
	</section>
	<section class="section cp report-detail__text">
		...
		<div class="limit--s">
			...
			<div class="section__body t--gamma-serif">
				<p>
					Um diese Informationslücke zu schließen, hat Wikimedia Deutschland gemeinsam mit Partnerorganisationen, die sich für digitale Freiheitsrechte einsetzen, den Digital-O-Maten entwickelt. Hierzu haben wir alle Parteien, die zur Bundestagswahl 2017 antraten und bei der Sonntagsfrage seit September 2016 konstant mindestens 5% Umfragewerte erreicht hatten, zu Themen wie Bildung, Internetzugang, Software und Open Data befragt.</br>
					Aus den Fragen und den dazugehörigen Antworten der Parteien ist der Digital-O-Mat entstanden.</br>
