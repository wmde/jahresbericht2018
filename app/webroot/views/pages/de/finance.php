<main class="finance bg--finance-main">
	<section class="section section__body cp">
		...
		<div class="limit--s">
			...
			<p class="t--gamma-serif finance__p">Wikimedia Deutschland ist wie viele spendensammelnde Organisationen bemüht, dass möglichst viel Geld der inhaltlichen Arbeit zugute kommt und möglichst wenig Kosten für indirekte Projektaufwendungen, sprich Verwaltungskosten anfallen. Gleichwohl sind letztere notwendig und sinnvoll, da sie die Mittelverwendung organisieren sowie Rechenschaft und damit Transparenz sichern. Die direkten Projektaufwendungen von Wikimedia Deutschland sind auf 5,1 Mio. Euro gestiegen (Vorjahr: 4,1 Mio. Euro). Ihr Anteil an den Gesamtaufwendungen sank auf 74 Prozent (Vorjahr: 78 Prozent).<br>
			<a href="<?= $url('report/2017', $lang) ?>"target="new">Mehr Informationen zu unseren Schwerpunkten 2017</a>
			</p>
