<main class="report-detail">
	<section
		...
		style="background-image: url(/assets/img/10_2017_hero.jpg)"
	>
		<img class="hero__center-illu" src="/assets/ico/10_2017_white.svg" alt="Illustration" >
		<div class="hero__filter"></div>
	</section>
	<section class="section cp report-detail__text">
		<div class="hero__caption t--epsilon">Visual Facilitators (<a href="https://commons.wikimedia.org/wiki/File:Wikimedia_Jahresplan_2017.jpg" target="new">Wikimedia Commons</a>), <a href="https://creativecommons.org/licenses/by-sa/4.0/legalcode" target="new">CC BY-SA 4.0</a></div>
		<div class="limit--s">
			<h1 class="section__title h--beta">
				<em>Annual Plan for 2017</em><br>Developing the organization collaboratively
			</h1>
			<div class="section__teaser t--gamma">
				Wikimedia Deutschland is a non-profit membership organization. It thrives on the ideas and suggestions of various groups. Therefore, it is essential that we get input from everyone involved as to whether the organization’s development is appropriate for society’s needs and our own expectations.
			</div>
