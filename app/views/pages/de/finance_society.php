	...
	<section class="section cp">
		<div class="limit--m fin-detail__aktiva">
			...
			<table class="ft">
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Forderungen aus Mittelweitergabeverpflichtungen</td>
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Sonstige Vermögensgegenstände</td>
	...
	<section class="section cp">
		<div class="limit--m fin-detail__passiva">
			...
			<table class="ft">
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Steuerrückstellungen</td>
