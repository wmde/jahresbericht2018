		...
		<div class="limit--m fin-detail__aktiva">
			...
			<table class="ft">
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Immaterielle Vermögensgegenstände</td>
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Forderungen und sonstige Vermögensgegenstände</td>
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Bankguthaben</td>
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Rechnungsabgrenzungsposten</td>
	...
	<section class="section cp">
		<div class="limit--m fin-detail__passiva">
			...
			<table class="ft">
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Eigenkapital</td>
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Aus Mittelweitergabeverpflichtungen</td>
	...
	<section class="section cp">
		<div class="limit--m fin-detail__rechnung">
			...
			<table class="ft">
				...
				<tr class="ft__row-line">
					<td class="ft__col-key">Aufwendungen aus Mittelweitergabe</td>
		...
		<div class="limit--m fin-detail__mittel">
			...
			<div class="bagel">
				<figure class="fig bagel__image bagel__image--l">
					<img src="/assets/img/kreis_f2_a.svg" alt="">
			...
			<div class="bagel bagel--s">
				<figure class="fig bagel__image bagel__image--s">
					<img src="/assets/img/kreis_f2_b.svg" alt="">
			...
			<div class="bagel bagel--s">
				<figure class="fig bagel__image bagel__image--s">
					<img src="/assets/img/kreis_f2_c.svg" alt="">
